    ...
    <div className="w-full pt-32 css-selector p-2">
      <div className="max-w-[500px] mx-auto mb-6 p-10 rounded-2xl bg-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mt-9">
            {error && <h3 className="text-red-500">{error.response?.data?.message || error.message}</h3>}
            <h5>Email</h5>
            <input
              {...register("email", { required: true })}
              type="email"
              placeholder="Email"
              className={`border mt-1 mb-3 border-[#1a1a1a] w-full py-2 px-3 rounded-lg ${errors.email ? "border-red-500" : ""}`}
            />
            ...
            <input
              ...
              className={`border mt-1 mb-3 border-[#1a1a1a] w-full py-2 px-3 rounded-lg ${errors.password ? "border-red-500" : ""}`}
            />
        ...
        <div className="mt-6 grid grid-cols-3 gap-3 h-12">
          ...
          <div className="bg-[#ebebeb] rounded-lg flex justify-center items-center">
            <img src="/facebooklogo (1).svg" className="h-6 hover:h-5" alt="Facebook" />
          </div>
          <div className="bg-[#ebebeb] rounded-lg flex justify-center items-center">
