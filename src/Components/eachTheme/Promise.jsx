        ...
        <div className='bg-[#fafaf9] text-black'>
            <div className=' max-w-7xl mx-auto flex flex-col md:flex-row py-10 gap-8'>
                <div className=' lg:w-1/2 w-full text-center lg:text-left'>
                    <h1 className=' text-4xl font-semibold'>Build with confidence — <br />the Theme Store promise</h1>
                </div>
                ...
                <div className=' lg:w-1/2 w-full grid lg:grid-cols-2 grid-cols-1 gap-8 '>
                    ...
                    <div>
                        ...
                        <div className='pl-8 text-[#56524E]'>
                            <p >
                            Every theme in the Theme Store meets Shopify’s performance standards,
                             ensuring a faster shopping experience for your buyers.
                            </p>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='pl-8 text-[#56524E]'>
                            ...
                            Try the theme for free with your own products, brand colors, and customizations.
                             One-time payment of $240 if you publish the theme to your store
                            </p>
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='pl-8 text-[#56524E]'>
                            <p >
                            Demo stores aren’t included, but you can get free stock photos from <a href="" className=' underline text-green-950'>Shopify Burst</a>.
                            </p>
                        </div>
                    </div>
                    <div>
